...
class StereoCamera(object):
    ...
    def __init__(self, chess_width, chess_height, detect=False, width=640, height=480):
        """
...
def get_parser():
    ...
    parser.add_argument('--camera_width', type=int, default=camera_width, help='camera resolution width')
    parser.add_argument('--camera_height', type=int, default=camera_height, help='camera resolution height')
...
if __name__ == '__main__':
    ...
    stereo = StereoCamera(args.width, args.height, detect=args.detect, width=args.camera_width, height=args.camera_height)
